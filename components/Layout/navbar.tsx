          ...
          <div className="flex justify-center flex-grow">
            <nav>
              <ul className="flex space-x-8">
                <li
                  className={`relative ${activeTab === "site-web" ? "text-blue-700" : "text-gray-800"}`}
                >
                  <Button
                    variant="ghost"
                    onClick={() => {
                ...
                <li
                  className={`relative ${activeTab === "mobile" ? "text-blue-700" : "text-gray-800"}`}
                >
                  <Button
                    variant="ghost"
                    onClick={() => {
          ...
          <nav>
            {isLoggedIn ? (
              <ul className="space-y-4">
                <li
                  className={
                    activeTab === "site-web" ? "text-blue-700" : "text-gray-800"
                  }
                >
                  <Button
                ...
                <li
                  className={
                    activeTab === "mobile" ? "text-blue-700" : "text-gray-800"
                  }
                >
                  <Button
                ...
                <li className="pt-2">
                  <Link href="/dashboard/web">
                    <Button
                      variant="outline"
                      className="text-blue-700 border-blue-700 rounded-full px-6 py-2 font-semibold w-full"
                    >
                      Tableau De Bord
                    </Button>
                  </Link>
