...
export const getHeadings = <ThrowOnError extends boolean = false>(options?: Options<GetHeadingsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetHeadingsResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const createHeading = <ThrowOnError extends boolean = false>(options: Options<CreateHeadingData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateHeadingResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const deleteProduct1 = <ThrowOnError extends boolean = false>(options: Options<DeleteProduct1Data, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteProduct1Response, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getOrderById1 = <ThrowOnError extends boolean = false>(options: Options<GetOrderById1Data, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetOrderById1Response, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
